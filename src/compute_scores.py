...
def preprocess_crime_data():
    ...
    crime_cost_severity= {
        "Méfait": -5,
        "Vols qualifiés": -10,
        "Vol dans / sur véhicule à moteur": -40,
        "Vol de véhicule à moteur": -40,
        "Introduction": -5,
        "Infractions entrainant la mort": -100
    }
...
def proprocess_car_crash_data():
    ...
    GRAVITY_COSTS = {
        "Dommages matériels inférieurs au seuil de rapportage": -5,
	    "Dommages matériels seulement" : -5,
	    "Léger" : -10,
	    "Grave": -50,
	    "Mortel": -75
    }
    ...
    def compute_cost(row):
        ...
        return GRAVITY - NB_MORTS * 25 - NB_BLESSES_GRAVES * 10 - NB_BLESSES_LEGERS * 4
